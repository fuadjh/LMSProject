        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstructorProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    InstructorAssignedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EssayAttachmentFileName = table.Column<string>(type: "nvarchar(260)", maxLength: 260, nullable: true),
                    EssayAttachmentPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    AwardedScore = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CourseOfferingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedByInstructorProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    MaxAttemptsPerStudent = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    TotalScore = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EvaluationDomain = table.Column<int>(type: "int", nullable: false),
                    SourceType = table.Column<int>(type: "int", nullable: false),
                    SourceDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    SuggestedScore = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_MajorId_Code",
                table: "Courses",
                columns: new[] { "MajorId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_CourseOfferingId_StudentProfileId",
                table: "Enrollments",
                columns: new[] { "CourseOfferingId", "StudentProfileId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExamAnswers_ExamSubmissionId_QuestionId",
                table: "ExamAnswers",
                columns: new[] { "ExamSubmissionId", "QuestionId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamSubmissions_ExamId_StudentProfileId_AttemptNumber",
                table: "ExamSubmissions",
                columns: new[] { "ExamId", "StudentProfileId", "AttemptNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstructorProfiles_PersonnelCode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionBanks_CourseId_InstructorProfileId",
                table: "QuestionBanks",
